...
print '<div class="container col-lg-6">
        ...
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6"><label for="replyTo">Reply-to</label><input type="text" class="form-control  input-sm " id="replyTo" name="replyTo" value="'.$replyTo.'" />
            ...
            <div class="row">
				<input type="hidden" class="" id="" name="FormServer" value="'.$SERVER_SESSIONS.'" />
